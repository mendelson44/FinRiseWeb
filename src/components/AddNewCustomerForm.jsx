    ...
    return (
        <>
            ...
            <div style={{ display: 'flex', flexDirection: 'row', marginTop: '0px' }}>
                ...
                <div style={{ flex: 1, display: 'flex', justifyContent: 'center',marginRight:'40px' }}>
                    <Zoom in={true}>
                        <form 
                        ...
                        >
                            <h1 style={{ fontSize: "25px", color: "black", textAlign: 'center',fontWeight: 'bold' ,marginBottom:"30px"}}>
                                Add New Client
                            </h1>
                            ...
                            <FormControl style={{ marginBottom: '20px', width: '100%' }}>
                                ...
                                <select
                                    ...
                                    onChange={handleChange}
                                    style={{ width: '100%', height: '50px', fontSize: '16px', padding: '10px' }}
                                >
                            ...
                            <Button 
                                style={{ backgroundColor: "rgb(14, 186, 151)", padding: '10px 20px' }} 
                                type="submit"
                            >
                                ADD
                            </Button>
